...
validated inline A2A files and may be discarded. Project skills and extensions remain in the
repository; Astro creates no session-scoped capability-materialization tree.
