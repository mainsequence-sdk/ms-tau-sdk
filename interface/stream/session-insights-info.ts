	...
	return {
		session: group(
			...
			"Astro's local runtime-session identity and lifecycle summary.",
			{
				...
				agentType: leaf("Agent Type", "The backend Agent.agent_type classification and prompt selector for this session, such as astro-orchestrator or mainsequence-project-executor."),
