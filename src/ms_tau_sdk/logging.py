...
def _add_component(
    ...
    event_dict.setdefault("component", event_dict.get("logger") or "ms_tau_sdk")
    return event_dict
...
def _environment_context() -> dict[str, object]:
    fields: dict[str, object] = {
        ...
        "sdk_version": f"ms-tau-sdk/{__version__}",
    }
...
class RequestContextMiddleware:
    ...
    def __init__(self, app: ASGIApp) -> None:
        self.app = app
        self.logger = structlog.get_logger("ms_tau_sdk.http")
